                  ...
                  <ul class="nav navbar-nav center_nav pull-right">
                    ...
                    <li class="nav-item active submenu dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li class="nav-item">
                          <a class="nav-link" href="electronics.html">Add Product</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="removeElectronics.html">Remove Product</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="updateElectronics.html">Update Product</a>
                        </li>
                      </ul>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="saleElectronics.html">Sale</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="orderElectronics.php">Order</a>
                    </li>
                  </ul>
                </div>
        ...
        <div class="container">
          ...
          >
            ...
            <div class="page_link">
              ...
              <a href="orderElectronics.php">User Orders</a>
            </div>
          </div>
        </div>
      </div>
